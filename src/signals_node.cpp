...
private:
    ...
    // Service clients mapped by IO type and service type
    ...
    // Additional service clients for ResetRobotState
    ...
    // Robot state variables for verification
...
int main(int argc, char **argv)
{
    ...
    auto node = std::make_shared<SignalsNode>();
